...
*/
const animalNames = [];
let animals = zooAnimals.forEach(animal => {
...
const lowerCase = [];
let animalName = zooAnimals.map(animal => {
...
let smallerPopulation = zooAnimals.filter(animal =>{
...
let population = zooAnimals.reduce((populationTotal, animal ) => {
