...
- The biggest difference I would say is that .map creates a new array with the results of calling a function.

2. What is the difference between a function and a method?

- They both accomplish the same thing the difference is a method is defined within an object. 
...
- 1. Window/Global: Which the value of "This" is attached globally.
...
- super() helps with binding giving access to a parent objects props.
